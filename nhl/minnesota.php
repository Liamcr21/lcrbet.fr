...
<h2 class=sous-titre>Minnesota Wild</h2>
<img src="../img/nhl/minnesota-wild-logo.png" alt="logo" class="img-ekip" >
...
try {
    ...
    foreach($dbh->query(' SELECT * FROM `nhl_stats` WHERE ID IN (15); `') as $row) {
