...
<h2 class=sous-titre>Anaheim Ducks</h2>
<img src="../img/nhl/anaheim-ducks-logo.png" alt="logo" class="img-ekip" >
...
try {
    $dbh = new PDO('mysql:host=localhost;dbname=u801021231_BDDNHLlcrbet', $user, $pass);
    foreach($dbh->query(' SELECT LOGO,PLAYER,GOAL FROM `buteur_nhl` WHERE ID IN (3) ORDER BY GOAL DESC LIMIT 10; `') as $row) {
        $row = array_map("utf8_encode", $row);
