  ...
  <header>
    <nav class="navbar" role="navigation">
        ...
        <ul class="navbar-links">
            <li class="navbar-link first lien "><a href="ps.php" >Paris sportif</a></li>
...
<body>
  ...
  <h2 class="h1-fond">Nos Services</h2>
    ...
    <div class="acc-resultat">
  <h2 class="h1-fond">Nos Résultats</h2>
      <div class="col1-acc">
        <div class="carre1">
          <p class="h1-res">NB pronos</p>
          <p class="p-res">0</p>
        </div>
        <div class="carre2">
          <p class="h1-res">Cote moyenne</p>
          <p class="p-res-modif">0.O</p>
        </div>
        <div class="carre3">
          <p class="h1-res">Win rate</p>
          <p class="p-res">0%</p>
        </div>
        <div class="carre4">
          <p class="h1-res">Bénéfices</p>
          <p class="p-res">0€</p>
        </div> 
      </div>    
